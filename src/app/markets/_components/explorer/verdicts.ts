...
export function areaVerdictFor(row: ExplorerRow, bedroom: number | null, goals: MarketGoals | null): AreaVerdict {
  ...
  return areaVerdict({
    ...
    adr: bed ? bed.adr : c.headline.adr,
    ...
    directBookingScore: c.directBooking?.score ?? null,
    seasonality: c.seasonality ? { score: c.seasonality.score, label: c.seasonality.label } : null,
