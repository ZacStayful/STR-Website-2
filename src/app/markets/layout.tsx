 ...
 *   • signed in, no profile → /upgrade, issued by the page so it can carry the
 *                             exact path to return to (see requireMarketAccess)
 *   • any member            → the explorer; paid lookups (listing checks,
 *                             quick views) are charged to their credit
