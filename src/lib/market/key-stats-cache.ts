...
import { PD_REGIONS, warmRegionKeyStats, type KeyStatsRead, type PdRegion, type WarmResult } from './key-stats';
...
type KeyStatsReader = (region: PdRegion, mode: 'cache' | 'buy') => Promise<KeyStatsRead>;
