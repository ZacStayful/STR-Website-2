...
export const UNIT_COST_SEED: UnitCostSeed[] = [
  ...
  { provider: 'propertydata', unit: 'stamp_duty', label: 'PropertyData /stamp-duty-calculator', unitCostPence: 2.5, notes: '1 credit; reconcile against the PropertyData invoice' },
  { provider: 'propertydata', unit: 'mortgage_rates', label: 'PropertyData /mortgage-rates', unitCostPence: 2.5, notes: '1 credit a day; bought by the market-warm cron, reports read the cache' },
  { provider: 'propertydata', unit: 'council_tax', label: 'PropertyData /council-tax', unitCostPence: 2.5, notes: '1 credit' },
  { provider: 'propertydata', unit: 'energy_efficiency', label: 'PropertyData /energy-efficiency (EPC)', unitCostPence: 2.5, notes: '1 credit' },
  ...
  { provider: 'propertydata', unit: 'demand', label: 'PropertyData /demand (sales market, per outcode)', unitCostPence: 2.5, notes: '1 credit; shared across an outcode for a week' },
